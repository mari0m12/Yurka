        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VodafonePhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentRequests_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Enrollments_PaymentRequests_PaymentRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_PaymentRequestId",
                table: "Enrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_UserId_UnitId",
                table: "Enrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRequests_UnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_GradeLevel_SortOrder",
                table: "Subjects",
                columns: new[] { "GradeLevel", "SortOrder" });
